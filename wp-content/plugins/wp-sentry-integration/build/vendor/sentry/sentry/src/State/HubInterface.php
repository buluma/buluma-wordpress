...
interface HubInterface
{
     ...
     */
    public function captureMessage(string $message, ?\Sentry\Severity $level = null) : ?\Sentry\EventId;
    /**
     ...
     * @param EventHint|null $hint      Object that can contain additional information about the event
     */
    public function captureException(\Throwable $exception) : ?\Sentry\EventId;
    /**
     ...
     * @param EventHint|null $hint Object that can contain additional information about the event
     */
    public function captureLastError() : ?\Sentry\EventId;
    /**
     ...
     */
    public function startTransaction(\Sentry\Tracing\TransactionContext $context) : \Sentry\Tracing\Transaction;
    /**
