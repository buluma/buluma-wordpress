...
final class ClientBuilder implements \Sentry\ClientBuilderInterface
{
    ...
    private function createDefaultTransportFactory() : \Sentry\Transport\DefaultTransportFactory
    {
        ...
        $httpClientFactory = new \Sentry\HttpClient\HttpClientFactory(\WPSentry\ScopedVendor\Http\Discovery\Psr17FactoryDiscovery::findUrlFactory(), \WPSentry\ScopedVendor\Http\Discovery\Psr17FactoryDiscovery::findResponseFactory(), $streamFactory, $this->httpClient, $this->sdkIdentifier, $this->sdkVersion);
